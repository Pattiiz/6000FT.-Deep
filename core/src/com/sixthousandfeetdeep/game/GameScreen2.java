...
public class GameScreen2 implements Screen {
	...
	public static Music bgMusic1, bgMusic3, boostMusic;
	...
	long boostTime = 0;
	float startBoost = 0;
	double speed1 = 2000000000 * 1.2, speed2 = 1000000000 / 1.2, speed3 = 20000 / 1.2, speed4 = 22000 / 1.2;
	double boost1 = 2000000000 * 1.2 / 3.5, boost2 = 1000000000 / 3.5, boost3 = 20000 / 3.5, boost4 = 22000 / 3.5;
	
	int positionX = 0;

	public GameScreen2 (final SixThousandFeetDeep gam) {
		this.game = gam;

		bg = new Texture(Gdx.files.internal("bgImg.jpg"));
		...
		bgMusic3 = Gdx.audio.newMusic(Gdx.files.internal("bg2sound.mp3"));
		...
		while(iter.hasNext()) {
		    ...
		    if (flags == 0)
		    {
		    	if(minedrop.overlaps(submarine)) {
		    		...
		    		if (coinGathered > SelectLevelMenu.highLV2)
		    		{
		    			SelectLevelMenu.highLV2 = coinGathered;
		    		}
